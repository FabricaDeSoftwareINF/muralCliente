...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            ...
            idRegistroGCM = getRegistrationId(context);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    idRegistroGCM = gcm.register(SENDER_ID);
                    msg = "Dispositivo registrado no GCM, registration ID=" + idRegistroGCM;
    ...
    private String getRegistrationId(Context context) {
        ...
        if (registrationId.isEmpty()) {
            Log.i(TAG, "Registro no GCM não encontrado.");
            return "";
        }
        ...
        if (registeredVersion != currentVersion) {
            Log.i(TAG, "Versão de app modificada.");
            return "";
        }
